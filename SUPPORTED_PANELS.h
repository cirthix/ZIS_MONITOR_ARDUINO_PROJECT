...
#define PIXEL_ORDERING_LEFTRIGHT_TESTING 2
...
//  #define EDID_0_SLAVE EDID_M280DGJ_ZIS_HALF
  ...
  #define LVDS_SWING_LEVEL LVDS_SWING_LEVEL_LOW 
  #define PIXEL_ORDERING PIXEL_ORDERING_LEFTRIGHT_TESTING
  #define LVDS_MAPPING LVDS_MAPPING_VESA
  ...
  PROGMEM const uint8_t EDID_DP_96OC[]             = {};
  
#if (HOST_INTERFACE == DLDVI)
  #define EDID_0_SLOT EDID_DVI_STOCK
  #define EDID_1_SLOT EDID_DVI_OC
#elif (HOST_INTERFACE == DISPLAYPORT)
  #define EDID_0_SLOT EDID_DP_96OC
  // why two identical?
  #define EDID_1_SLOT EDID_DP_96OC
#else
  #error "Selected interface does not support selected panel"
#endif
  ...
  inline void panel_script_startup(){
    // Note : connect pin 27  on 51pin LVDS connector to 3.3v
    // Enable overdrive.  Connect pin6 on 51pin LVDS connector to GPIO1
  #ifdef PANEL_GPIO0
    pinMode(PANEL_GPIO0, OUTPUT);
    digitalWrite(PANEL_GPIO0, HIGH);
  #endif
// Set LVDS_BIT_DEPTH.  Connect pin7 on 51pin LVDS connector to GPIO0
  #ifdef PANEL_GPIO1
    pinMode(PANEL_GPIO1, OUTPUT);
	#if (PANEL_BIT_DEPTH == 10)
      digitalWrite(PANEL_GPIO1, HIGH);
    #else 
      digitalWrite(PANEL_GPIO1, LOW);
    #endif
  #endif
    
    } // No panel startup script is necessary for this panel.  By default, any GPIOs will be left floating
